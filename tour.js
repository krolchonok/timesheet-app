(function () {
  const TOUR_STEPS = [
    ...
    },
    {
      ...
      text: 'Здесь появляются ваши проекты — добавляйте их кнопкой «+ Задача» (тип «Проектная задача») и вносите часы по дням.',
      fallbackText: 'Ниже ваших задач — блок «Проектные задачи»: добавляйте их кнопкой «+ Задача» (тип «Проектная задача») и вносите часы.',
    },
    {
