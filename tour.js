(function () {
  const TOUR_STEPS = [
    ...
    },
    {
      ...
      text: 'Добавляет новую строку в таблицу «Остальные задачи».',
    },
    {
      selector: '#btn-export',
      title: 'Экспорт CSV',
    ...
    },
    {
      ...
      text: 'Здесь можно добавить свои проекты кнопкой «+ Проект»: своё название проекта, название задачи и часы по дням.',
      fallbackText: 'Ниже ваших задач — блок «Проектные задачи»: добавляйте свои проекты кнопкой «+ Проект» и вносите часы.',
    },
    {
