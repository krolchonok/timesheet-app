(function () {
  const TOUR_STEPS = [
    ...
    },
    {
      ...
      text: 'Системная строка: название задачи только для просмотра, часы по дням вносите вы.',
      fallbackText: 'Ниже ваших задач появится «Проектные задачи» — системная строка, куда вы вносите только часы.',
    },
    {
